/*
 * $HeadURL: http://juliusdavies.ca/svn/not-yet-commons-ssl/tags/commons-ssl-0.3.11/src/java/org/apache/commons/ssl/HostnameVerifier.java $
 * $Revision: 121 $
...
public interface HostnameVerifier extends javax.net.ssl.HostnameVerifier {
    ...
    abstract class AbstractVerifier implements HostnameVerifier {
        ...
        public void check(String[] host, X509Certificate cert)
        	...
        	//####Next three lines commented temporarily.  eventually we will need it
